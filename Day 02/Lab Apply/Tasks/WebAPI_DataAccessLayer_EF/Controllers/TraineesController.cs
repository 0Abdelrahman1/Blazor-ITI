...
namespace WebAPI_DataAccessLayer_EF.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TraineesController : ControllerBase
    {
        private readonly InternshipDB _context;

        public TraineesController(InternshipDB context)
        {
            _context = context;
        }
        ...
        [HttpPut]
        public async Task<IActionResult> PutTrainee(Trainee trainee)
        {
